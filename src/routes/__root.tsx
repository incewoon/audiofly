...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AudioFly is an offline-ready PWA that converts MP4 to MP3 right on your device." },
      { name: "author", content: "AudioFly" },
      { name: "theme-color", content: "#0f172a" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "AudioFly" },
      { property: "og:title", content: "AudioFly — MP4 to MP3 Converter" },
      { property: "og:description", content: "Offline MP4 → MP3 converter that runs entirely in your browser." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "AudioFly — MP4 to MP3 Converter" },
      { name: "twitter:description", content: "Offline MP4 → MP3 converter that runs entirely in your browser." },
    ],
    links: [
